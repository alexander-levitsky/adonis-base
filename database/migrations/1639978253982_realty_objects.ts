...
export default class RealtyObjects extends BaseSchema {
  ...
  public async up () {
    this.schema.createTable(this.tableName, (table) => {
     ...
     table.text('commission').nullable().nullable().comment('Коммиссия');
     ...
     table.enum('moderate_status', ['default', 'hidden']).defaultTo('default').index().comment('статус при модерации фоток');
    })
  }
